...
<div style="max-width: 600px; margin: 0 auto;">
    <h1 style="margin-bottom: 2rem; color: #c9a227;">Edit Investment</h1>
    ...
    <div class="card">
        <form method="POST" action="{{ route('admin.investments.update', $investment) }}">
            ...
            <div class="form-group">
                ...
                <textarea id="admin_notes" name="admin_notes" rows="4">{{ $investment->admin_notes }}</textarea>
                @error('admin_notes')<span style="color: #ef5350;">{{ $message }}</span>@enderror
            </div>
