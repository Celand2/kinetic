...
<div class="card" style="max-width: 800px; margin: 0 auto;">
    <div style="border-bottom: 1px solid rgba(201, 162, 39, 0.2); padding-bottom: 1.5rem; margin-bottom: 1.5rem;">
        ...
        <div style="color: #b0bfd9; font-size: 0.9rem;">
            From: <strong>{{ $message->sender->full_name }}</strong> on {{ $message->created_at->format('M d, Y H:i A') }}
        </div>
    </div>

    <div style="background: rgba(201, 162, 39, 0.05); padding: 1.5rem; border-radius: 8px; line-height: 1.8;">
